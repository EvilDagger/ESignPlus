...
4. This isn't a bug but it's a small nuisance. The bundle identifier is still xyz.yyyue.esign and the name (and icon) are eSign. This is especially true when installing the IPA but it also happens with the traditional method. A fix must be rolled down in the beta phase!
